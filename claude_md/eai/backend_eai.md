...
│        컨트롤러         │ Method │                      Path                       │                         설명                         │                                                                                                                    
├─────────────────────────┼────────┼─────────────────────────────────────────────────┼──────────────────────────────────────────────────────┤                                                                                                                    
│ EaiInterfaceController  │ GET    │ /api/eai/interfaces                             │ 인터페이스 목록 (status, adapterType, keyword 필터)  │                                                                                                                    
├─────────────────────────┼────────┼─────────────────────────────────────────────────┼──────────────────────────────────────────────────────┤                                                                                                                    
│                         │ GET    │ /api/eai/interfaces/{id}                        │ 단건 조회                                            │
├─────────────────────────┼────────┼─────────────────────────────────────────────────┼──────────────────────────────────────────────────────┤
│                         │ POST   │ /api/eai/interfaces                             │ 등록                                                 │
├─────────────────────────┼────────┼─────────────────────────────────────────────────┼──────────────────────────────────────────────────────┤
│                         │ PUT    │ /api/eai/interfaces/{id}                        │ 수정                                                 │
├─────────────────────────┼────────┼─────────────────────────────────────────────────┼──────────────────────────────────────────────────────┤
│                         │ PATCH  │ /api/eai/interfaces/{id}/toggle                 │ 활성/비활성 토글                                     │
├─────────────────────────┼────────┼─────────────────────────────────────────────────┼──────────────────────────────────────────────────────┤
│                         │ DELETE │ /api/eai/interfaces/{id}                        │ 삭제                                                 │
├─────────────────────────┼────────┼─────────────────────────────────────────────────┼──────────────────────────────────────────────────────┤
│                         │ POST   │ /api/eai/interfaces/receive/{interfaceId}       │ Push 수신 → Kafka 발행                               │
├─────────────────────────┼────────┼─────────────────────────────────────────────────┼──────────────────────────────────────────────────────┤
│                         │ POST   │ /api/eai/interfaces/{interfaceId}/test          │ 테스트 전송                                          │
├─────────────────────────┼────────┼─────────────────────────────────────────────────┼──────────────────────────────────────────────────────┤
│ EaiMessageController    │ GET    │ /api/eai/messages                               │ 메시지 이력 목록 (interfaceId, status, keyword 필터) │
├─────────────────────────┼────────┼─────────────────────────────────────────────────┼──────────────────────────────────────────────────────┤
│                         │ GET    │ /api/eai/messages/{id}                          │ 단건 조회                                            │
├─────────────────────────┼────────┼─────────────────────────────────────────────────┼──────────────────────────────────────────────────────┤
│                         │ POST   │ /api/eai/messages/{id}/retry                    │ 재처리                                               │
├─────────────────────────┼────────┼─────────────────────────────────────────────────┼──────────────────────────────────────────────────────┤
│ EaiScheduleController   │ GET    │ /api/eai/schedules                              │ 스케줄 목록 (interfaceId 필터)                       │
├─────────────────────────┼────────┼─────────────────────────────────────────────────┼──────────────────────────────────────────────────────┤
│                         │ GET    │ /api/eai/schedules/{id}                         │ 단건 조회                                            │
├─────────────────────────┼────────┼─────────────────────────────────────────────────┼──────────────────────────────────────────────────────┤
│                         │ POST   │ /api/eai/schedules                              │ 등록                                                 │
├─────────────────────────┼────────┼─────────────────────────────────────────────────┼──────────────────────────────────────────────────────┤
│                         │ PUT    │ /api/eai/schedules/{id}                         │ 수정                                                 │
├─────────────────────────┼────────┼─────────────────────────────────────────────────┼──────────────────────────────────────────────────────┤
│                         │ POST   │ /api/eai/schedules/{id}/run                     │ 즉시 실행                                            │
├─────────────────────────┼────────┼─────────────────────────────────────────────────┼──────────────────────────────────────────────────────┤
│                         │ DELETE │ /api/eai/schedules/{id}                         │ 삭제                                                 │
├─────────────────────────┼────────┼─────────────────────────────────────────────────┼──────────────────────────────────────────────────────┤
│ EaiAdapterController    │ GET    │ /api/eai/adapters                               │ 어댑터 설정 목록 (interfaceId 필터)                  │
├─────────────────────────┼────────┼─────────────────────────────────────────────────┼──────────────────────────────────────────────────────┤
│                         │ GET    │ /api/eai/adapters/{id}                          │ 단건 조회                                            │
├─────────────────────────┼────────┼─────────────────────────────────────────────────┼──────────────────────────────────────────────────────┤
│                         │ POST   │ /api/eai/adapters                               │ 등록                                                 │
├─────────────────────────┼────────┼─────────────────────────────────────────────────┼──────────────────────────────────────────────────────┤
│                         │ PUT    │ /api/eai/adapters/{id}                          │ 수정                                                 │
├─────────────────────────┼────────┼─────────────────────────────────────────────────┼──────────────────────────────────────────────────────┤
│                         │ DELETE │ /api/eai/adapters/{id}                          │ 삭제                                                 │
├─────────────────────────┼────────┼─────────────────────────────────────────────────┼──────────────────────────────────────────────────────┤
│ EaiMonitoringController │ GET    │ /api/eai/monitoring/stream                      │ SSE 스트림 (5초 주기)                                │
├─────────────────────────┼────────┼─────────────────────────────────────────────────┼──────────────────────────────────────────────────────┤
│                         │ GET    │ /api/eai/monitoring/snapshot                    │ 현재 대시보드 스냅샷                                 │
├─────────────────────────┼────────┼─────────────────────────────────────────────────┼──────────────────────────────────────────────────────┤
...
● Push 완료. eai_db_adapter_def CRUD API 엔드포인트입니다.

┌────────┬───────────────────────────┬───────────────────────────────────────────┐                                                                                                             
│ Method │            URL            │                   설명                    │                                                                                                             
├────────┼───────────────────────────┼───────────────────────────────────────────┤                                                                                                             
│ GET    │ /eai/db-adapters      │ 전체 목록 조회 (query: dbType, direction) │                                                                                                             
├────────┼───────────────────────────┼───────────────────────────────────────────┤
│ GET    │ /eai/db-adapters/{id} │ 단건 조회                                 │
├────────┼───────────────────────────┼───────────────────────────────────────────┤
│ POST   │ /eai/db-adapters      │ 신규 등록                                 │
├────────┼───────────────────────────┼───────────────────────────────────────────┤
│ PUT    │ /eai/db-adapters/{id} │ 수정 (dbPw 미전송 시 기존 값 유지)        │
├────────┼───────────────────────────┼───────────────────────────────────────────┤
│ DELETE │ /eai/db-adapters/{id} │ 삭제                                      │
└────────┴───────────────────────────┴───────────────────────────────────────────┘
